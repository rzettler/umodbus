...
async def _read_coils_test_2(host, slave_addr, register_definitions, sleep_fn, **kwargs):
    coil_address = kwargs["coil_address"]
...
async def _read_hregs_test_2(host, slave_addr, register_definitions, sleep_fn, **kwargs):
    hreg_address = kwargs["hreg_address"]
...
async def run_host_tests(host, slave_addr, register_definitions):
